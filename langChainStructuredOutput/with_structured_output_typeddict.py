...
#creating a schema for review class
#Simple typedict
class Review(TypedDict):
    #summary : str #usgae of simple typeddict
    #sentiment : str#usage of simple typeddict
    key_themes : Annotated[list[str],"Write down all the key themes discussed in the review in a list"]
    summary : Annotated[str,"A brief summary of the review"]#annotated will guide explicity the llm 
